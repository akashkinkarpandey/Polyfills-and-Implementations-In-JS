...
console.log(first(obj)(2, 3, 4));//gives correct output
//{a: {b: 9, c: 9}
//d : 9 }
console.log(first(obj)(1, 1, 1));//gives same output as previous as original object is mutated,needs to be fixed
